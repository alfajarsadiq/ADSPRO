...
(function (global) {
    ...
    // Factory function to create SplitText
	const factory = function (D) {
        ...
        l.version = "3.11.2";
        // Assign to the mock object passed in
        D.SplitText = l;
	};

    // Execution
    var mock = {};
    // Pass mock object to capture the export
    factory(mock);
    SplitText = mock.SplitText;
